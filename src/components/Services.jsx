...
/* animation delay letters but it doesnt work on scroll  
...
const Services = ({ id }) => {
    ...
    return ( 
        <>
           <div  id={id} className={classes.pageCtn} ref={titleRef}>
      <div  className={`${classes.leftCtn} ${animate ? classes.animate : ""}`}>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>S</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>E</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>R</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>V</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>I</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>C</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>E</span>
        <span className={`${classes.letter} ${animate ? classes.animate : ""}`}>S</span>
        <p>things I can help you with</p>
      </div>
